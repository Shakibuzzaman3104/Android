...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int PICK_IMAGE_FLAG=1;
    ...
    private void writeDatabase(String FirstName,String LastName,String Age,String Email,String BG)
    {
        ...
        String a=null;
        Users user = new Users(Age,BG,Email,FirstName,LastName,a);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==PICK_IMAGE_FLAG && resultCode == RESULT_OK
                && data!=null && data.getData()!=null)
        {
            Uri mImageUri = data.getData();
            iv.setImageURI(mImageUri);   //If I don't Want to use Picasso
        }
    }
}
